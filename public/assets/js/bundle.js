...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (formGeraSenha) {
...
function geraSenha(qtd, maiusculas, minusculas, numeros, simbolos) {
  ...
  } //a cada volta do laço sera colocado em ordem, letra maiuscula, minuscula, numero e simbolo se tais forem true, ou seja, selecionadas
  //porem se eu coloco uma qtd de 5 e true em todos, será 5 para cada e nao é isso que quero


  return senhaArray.join('').slice(0, qtd); //a cada caractere não havera espaçamento e será fatiado entre 0 e a qtd escolida, sem duplicar
}
